        ...
        tbody.innerHTML += `
          <tr class="user-row" data-id="${u.id}">
            <td>
              ...
              <div style="font-size:11px; color:#64748b;">${u.email ? H.esc(u.email) : 'No Email Added'}</div>
            </td>
        ...
        <div class="modal animate" style="max-width:450px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <p style="font-size:11px; color:#94a3b8; margin:-4px 0 6px;">Enables "Sign in with Google" for this person, and is used for password-reset emails. Must be an actual Gmail/Google account.</p>
              <input type="email" class="form-input" id="u-email" value="${isEdit && u.email ? H.esc(u.email) : ''}" placeholder="e.g. johndoe@gmail.com">
            </div>
            <div class="form-group">
